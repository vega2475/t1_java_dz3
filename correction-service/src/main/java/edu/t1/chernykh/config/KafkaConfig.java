...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, Long> transactionConsumerFactory(){
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Long> transactionDtoConcurrentKafkaListenerContainerFactory(){
    ...
    @Bean
    public KafkaTemplate<String, TransactionDto> transactionProducerKafkaTemplate() {
